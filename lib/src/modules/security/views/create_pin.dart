...
class CreatePinView extends ConsumerWidget with FxUiToolkit {
  CreatePinView({super.key, this.isConfirming = false});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return PinStepTemplate(
      title: '${isConfirming ? 'Confirm' : 'Create'} your PIN',
      subtitle: 'Enter your new ${isConfirming ? 'confirm' : 'create'} PIN to access your account',
      onCompleted: (pin) => controller.onCreatePin(pin, isConfirming: isConfirming),
    );
  }
}