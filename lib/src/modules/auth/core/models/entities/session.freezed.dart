...
@override
String toString() {
  return 'Session(id: $id, deviceInfo: $deviceInfo, ipAddress: $ipAddress, createdAt: $createdAt, expiresAt: $expiresAt)';
}
...
class _Session implements Session {
  const _Session({required this.id, required this.deviceInfo, required this.ipAddress, required this.createdAt, required this.expiresAt});
