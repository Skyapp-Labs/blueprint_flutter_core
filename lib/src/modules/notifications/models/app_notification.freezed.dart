...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,body,read,createdAt,const DeepCollectionEquality().hash(data));
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,body,read,createdAt,const DeepCollectionEquality().hash(_data));
